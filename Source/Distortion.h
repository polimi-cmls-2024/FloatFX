/*
  This class implements the Distortion effect. It contains functions to set the distortion parameters and
...
private:
    ...
    //Distort the sample as input using a non linear function
